...
$sql = "SELECT product_id, prdct_name, prdct_price, prdct_img FROM product_tbl";
    ...
    <div class="container-xxl bg-light my-6 py-6 pt-0" ;">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-6 mb-4">Products</h1>
            </div>
            <div class="row g-4">
                    ...
                    <div class="product-item d-flex flex-column bg-white rounded overflow-hidden h-100">
                        ...
                        <div class="position-relative mt-auto">
                            ...
                            <div class="product-overlay">
                                <a class="btn btn-lg-square btn-outline-light rounded-circle" href="cake.php"><i
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="product-item d-flex flex-column bg-white rounded overflow-hidden h-100">
                        ...
                        <div class="position-relative mt-auto">
                            ...
                            <div class="product-overlay">
                                <a class="btn btn-lg-square btn-outline-light rounded-circle" href="breads.php"><i
                                        class="fa fa-eye text-primary"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="product-item d-flex flex-column bg-white rounded overflow-hidden h-100">
                        ...
                        <div class="position-relative mt-auto">
                            ...
                            <div class="product-overlay">
                                <a class="btn btn-lg-square btn-outline-light rounded-circle" href="cookies.php"><i
                                        class="fa fa-eye text-primary"></i></a>
                            </div>
                        </div>
                    </div>
