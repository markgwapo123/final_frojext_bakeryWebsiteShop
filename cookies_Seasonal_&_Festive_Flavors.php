...
$sql = "SELECT product_id, prdct_name, prdct_price, prdct_img, quantity FROM product_tbl WHERE category = 'seasonal_cookies'";
...
<body>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content" id="dropdownContent" style="display: none;">
        <form id="addProduct" method="POST" action="add_product.php" enctype="multipart/form-data">
          ...
          <input type="hidden" name="category" value="seasonal_cookies" />
  ...
  <h1 class="cakes">Seasonal & Festive Flavors</h1>
  ...
  <div class="flavorsbtn">
    ...
    <br />
    <a href="cookies_Gourmet & Unique Flavors.php" class="sff">Gourmet & Unique Flavors</a>
  </div>
  <!-- Product End -->
