        ...
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <div class="cakeflavor">
                    <h1 class="cakes">Bread</h1><br>
                    <div class="flavor">
                        <a href="classic_bread.php" class="class">Classic Flavors</a><br><br><br>
                        <a href="bread_Gourmet & Unique Flavors.php" class="bread_Go">Gourmet & Unique Flavors</a><br><br><br>
                        <a href="bread_Seasonal_&_Festive_Flavors.php" class="sea">Seasonal & Festive Flavors</a>
                    </div>
                </div>
               <div class="imgcake">
                <img class="cake1" src="img/cbread.jpg" alt="cake">
                <img class="cake2" src="img/cbread1.jpg" alt="cake">
                <img class="cake3" src="img/cbread2.jpg" alt="cake">
               </div>
            </div>
        </div>
    </div>
