...
$sql = "SELECT product_id, prdct_name, prdct_price, prdct_img, quantity FROM product_tbl WHERE category = 'classic_bread'";
...
<body>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content" id="dropdownContent" style="display: none;">
        <form id="addProduct" method="POST" action="add_product.php" enctype="multipart/form-data">
          ...
          <input type="hidden" name="category" value="classic_bread" />
  ...
  <h1 class="cakes">Classic Flavor</h1>
    ...
    <?php if (!empty($products)): ?>
      <?php foreach ($products as $product): ?>
        <div class="product">
          ...
          <?php else: ?>
            <img src="img/default-image.png" alt="Default Image" /> <!-- Fallback image -->
          <?php endif; ?>
  ...
  <div class="flavorsbtn">
    <a href="bread_Gourmet%20&%20Unique%20Flavors.php" class="guf">Gourmet & Unique Flavors</a><br />
    <br />
    <a href="bread_Seasonal_&_Festive_Flavors.php" class="sff">Seasonal & Festive Flavors</a>
  </div>
  <!-- Product End -->
