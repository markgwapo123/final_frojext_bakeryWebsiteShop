...
$sql = "SELECT product_id, prdct_name, prdct_price, prdct_img, quantity FROM product_tbl WHERE category = 'gourmet_cookies'";
...
<body>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content" id="dropdownContent" style="display: none;">
        <form id="addProduct" method="POST" action="add_product.php" enctype="multipart/form-data">
          ...
          <input type="hidden" name="category" value="gourmet_cookies" />
  ...
  <h1 class="cakes">Gourmet & Unique Flavors</h1>
  ...
  <div class="flavorsbtn">
    <a href="classic_cookies.php" class="guf">Classic Flavors</a><br />
    <br />
    <a href="cookies_Seasonal_&_Festive_Flavors.php" class="sff">Seasonal & Festive Flavors</a>
  </div>
  <!-- Product End -->
