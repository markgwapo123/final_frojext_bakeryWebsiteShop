...
$sql = "SELECT product_id, prdct_name, prdct_price, prdct_img, quantity FROM product_tbl WHERE category = 'classic_cookies'";
...
<body>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content" id="dropdownContent" style="display: none;">
        <form id="addProduct" method="POST" action="add_product.php" enctype="multipart/form-data">
          ...
          <input type="hidden" name="category" value="classic_cookies" />
  ...
  <div class="flavorsbtn">
    <a href="cookies_Gourmet%20&%20Unique%20Flavors.php" class="guf">Gourmet & Unique Flavors</a><br />
    <br />
