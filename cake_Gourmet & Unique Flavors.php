...
$sql = "SELECT product_id, prdct_name, prdct_price, prdct_img, quantity FROM product_tbl WHERE category = 'cake_gourmet'";
...
<body>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content" id="dropdownContent" style="display: none;">
        <form id="addProduct" method="POST" action="add_product.php" enctype="multipart/form-data">
          ...
          <input type="hidden" name="category" value="cake_gourmet" />
  ...
  <div class="flavorsbtn">
    <a href="classic_Flavor.php" class="guf">Classic Flavors</a><br />
    <br />
