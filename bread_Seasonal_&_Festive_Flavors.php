...
$sql = "SELECT product_id, prdct_name, prdct_price, prdct_img, quantity FROM product_tbl WHERE category = 'seasonal_bread'";
...
<body>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content" id="dropdownContent" style="display: none;">
        <form id="addProduct" method="POST" action="add_product.php" enctype="multipart/form-data">
          ...
          <input type="hidden" name="category" value="seasonal_bread" />
  ...
  <div class="flavorsbtn">
    ...
    <br />
    <a href="bread_Gourmet & Unique Flavors.php" class="sff">Gourmet & Unique Flavors</a>
  </div>
  <!-- Product End -->
