        ...
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <div class="cakeflavor">
                    <h1 class="cakes">Cakes</h1><br>
                    <div class="flavor">
                        <a href="sign_in.php" class="class">Classic Flavors</a><br><br><br>
                        <a href="cake_Gourmet & Unique Flavors.php" class="gour">Gourmet & Unique Flavors</a><br><br><br>
                        <a href="cake_Seasonal_&_Festive_Flavors.php" class="sea">Seasonal & Festive Flavors</a>
                    </div>
                </div>
               <div class="imgcake">
                <img class="cake1" src="img/cake.jpg" alt="cake">
                <img class="cake2" src="img/cake2.jpg" alt="cake">
                <img class="cake3" src="img/cake3.jpg" alt="cake">
               </div>
            </div>
        </div>
    </div>
